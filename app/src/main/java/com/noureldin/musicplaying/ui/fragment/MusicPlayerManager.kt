...
class MusicPlayerManager : MediaPlayer.OnCompletionListener {
    ...
    fun pauseSong(playPause: ImageView) {
        if (mediaPlayer?.isPlaying == true) {
            ...
            showToast("Please select a song before pausing.")
        }
        updatePlayPauseButtonUI(playPause)
    }
    ...
    fun resumeSong(playPause: ImageView) {
        if (isPaused) {
            ...
            showToast("Please select a song before resuming.")
        }
        updatePlayPauseButtonUI(playPause)
    }
    ...
    private fun showToast(message: String) {
        // You can customize the duration or layout of the toast as needed.
